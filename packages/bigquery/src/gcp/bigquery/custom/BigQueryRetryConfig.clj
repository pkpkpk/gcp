...
(defn ^BigQueryRetryConfig from-edn
  [arg]
  (g/strict! :gcp.bigquery.custom/BigQueryRetryConfig arg)
...
(defn to-edn
  ...
  {:post [(g/strict! :gcp.bigquery.custom/BigQueryRetryConfig %)]}
  (cond-> {}
...
(def schema
  [:map
   {:closed true,
    ...
    :gcp/key :gcp.bigquery.custom/BigQueryRetryConfig}
...
(g/include-schema-registry!
  (with-meta {:gcp.bigquery.custom/BigQueryRetryConfig schema}
