...
(defn ^ForeignKey from-edn
  ...
  (global/strict! :gcp.bigquery.v2/ForeignKey arg)
...
(defn to-edn [^ForeignKey arg]
  {:post [(global/strict! :gcp.bigquery.v2/ForeignKey %)]}
...
(def schemas
  {:gcp.bigquery.v2/ForeignKey
   [:map {:closed true}
    ...
    [:referencedTable {:doc "The table referenced by this foreign key"} :gcp.bigquery.v2/TableId]
    [:referencedColumns {:doc "The set of column references for this foreign key"} [:sequential :gcp.bigquery.v2/ColumnReference]]]})
