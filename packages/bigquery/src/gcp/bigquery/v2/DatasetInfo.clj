...
(defn ^DatasetInfo from-edn
  ...
  (global/strict! :gcp.bigquery.v2/DatasetInfo arg)
...
(defn to-edn [^DatasetInfo arg]
  {:post [(global/strict! :gcp.bigquery.v2/DatasetInfo %)]}
...
(def schemas
  {:gcp.bigquery.v2/DatasetInfo
   [:map
    [:acl {:optional true} [:seqable :gcp.bigquery.v2/Acl]]
    [:datasetId :gcp.bigquery.v2/DatasetId]
    [:defaultCollation {:optional true} :string]
    [:defaultEncryptionConfiguration {:optional true} :gcp.bigquery.v2/EncryptionConfiguration]
    [:defaultPartitionExpirationMs {:optional true} :int]
    [:defaultTableLifetime {:optional true} :int]
    [:description {:optional true} :string]
    [:etag {:optional true} :string]
    [:externalDatasetReference {:optional true} :gcp.bigquery.v2/ExternalDatasetReference]
