...
(defn ^StandardSQLField Field:from-edn
  ...
  (global/strict! :gcp.bigquery.v2/StandardSQLField arg)
...
(defn Field:to-edn [^StandardSQLField arg]
  {:post [(global/strict! :gcp.bigquery.v2/StandardSQLField %)]}
...
(defn ^StandardSQLStructType StructType:from-edn
  ...
  (global/strict! :gcp.bigquery.v2/StandardSQLStructType arg)
...
(defn StructType:to-edn [^StandardSQLStructType arg]
  {:post [(global/strict! :gcp.bigquery.v2/StandardSQLStructType %)]}
...
(defn ^StandardSQLDataType DataType:from-edn
  ...
  (global/strict! :gcp.bigquery.v2/StandardSQLDataType arg)
...
(defn DataType:to-edn [^StandardSQLDataType arg]
  {:post [(global/strict! :gcp.bigquery.v2/StandardSQLDataType %)]}
...
(defn ^StandardSQLTableType TableType:from-edn
  [{:keys [columns] :as arg}]
  (global/strict! :gcp.bigquery.v2/StandardSQLTableType arg)
...
(defn TableType:to-edn [^StandardSQLTableType arg]
  {:post [(global/strict! :gcp.bigquery.v2/StandardSQLTableType %)]}
  {:columns (map Field:to-edn (.getColumns arg))})

(def schemas
  {:gcp.bigquery.v2/StandardSQLDataType
   [:map {:closed true}
    [:typeKind {:optional true} :gcp.bigquery.v2/StandardSQLTypeName]
    [:typeName {:optional true} :gcp.bigquery.v2/StandardSQLTypeName]
    [:arrayElementType {:optional true} [:ref :gcp.bigquery.v2/StandardSQLDataType]]
    [:structType {:optional true} [:ref :gcp.bigquery.v2/StandardSQLStructType]]]

   :gcp.bigquery.v2/StandardSQLField
   [:map {:closed true}
    [:name {:optional true} :string]
    [:dataType :gcp.bigquery.v2/StandardSQLDataType]]

   :gcp.bigquery.v2/StandardSQLStructType
   [:map {:closed true}
    [:fieldList [:sequential :gcp.bigquery.v2/StandardSQLField]]]

   :gcp.bigquery.v2/StandardSQLTableType
   [:map {:closed true}
    [:columns [:sequential :gcp.bigquery.v2/StandardSQLField]]]

   :gcp.bigquery.v2/StandardSQLTypeName [:enum "TIME" "FLOAT64" "INTERVAL" "BIGNUMERIC" "BOOL" "DATE" "BYTES" "GEOGRAPHY" "NUMERIC" "ARRAY" "JSON" "STRING" "DATETIME" "STRUCT" "TIMESTAMP" "INT64" "RANGE"]})
