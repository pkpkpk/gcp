...
(ns gcp.api.services.bigquery.model.Row
  {:doc
   ...
   :gcp.dev/certification
     {:base-seed 1775130916871
      :manifest "2096f8e8-3cdd-50e2-9b64-67d099f5c3be"
      :passed-stages
        {:smoke 1775130916871 :standard 1775130916872 :stress 1775130916873}
      :protocol-hash
        "f27f34d24f3d81b3e05f9de655c6ce1de28b53e620c5f9c1978cbce793727f86"
      :timestamp "2026-04-02T11:55:18.057025406Z"}}
...
(defn to-edn
  ...
  (when arg
    (cond-> {}
      ...
      (seq (.getEntries arg)) (assoc :entries
