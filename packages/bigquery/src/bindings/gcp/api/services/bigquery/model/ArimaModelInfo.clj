...
(ns gcp.api.services.bigquery.model.ArimaModelInfo
  {:doc
   ...
   :gcp.dev/certification
     {:base-seed 1775130879695
      :manifest "2096f8e8-3cdd-50e2-9b64-67d099f5c3be"
      :passed-stages
        {:smoke 1775130879695 :standard 1775130879696 :stress 1775130879697}
      :protocol-hash
        "f27f34d24f3d81b3e05f9de655c6ce1de28b53e620c5f9c1978cbce793727f86"
      :timestamp "2026-04-02T11:54:40.914785352Z"}}
  (:require [gcp.api.services.bigquery.model.ArimaCoefficients :as
             ArimaCoefficients]
            [gcp.api.services.bigquery.model.ArimaFittingMetrics :as
             ArimaFittingMetrics]
...
(defn ^ArimaModelInfo from-edn
  [arg]
  (global/strict! :gcp.api.services.bigquery.model/ArimaModelInfo arg)
...
(defn to-edn
  [^ArimaModelInfo arg]
  {:post [(global/strict! :gcp.api.services.bigquery.model/ArimaModelInfo %)]}
  (when arg
    (cond-> {}
...
(def schema
  [:map
   {:closed true,
    ...
    :gcp/key :gcp.api.services.bigquery.model/ArimaModelInfo}
   [:arimaCoefficients
    {:getter-doc
       "Arima coefficients.\n\n@return value or {@code null} for none",
     :setter-doc
       "Arima coefficients.\n\n@param arimaCoefficients arimaCoefficients or {@code null} for none",
     :optional true} :gcp.api.services.bigquery.model/ArimaCoefficients]
   [:arimaFittingMetrics
    {:getter-doc
...
(global/include-schema-registry!
  (with-meta {:gcp.api.services.bigquery.model/ArimaModelInfo schema}
    {:gcp.global/name "gcp.api.services.bigquery.model.ArimaModelInfo"}))