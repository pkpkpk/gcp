...
(ns gcp.bigquery.ConnectionSettings
  {:doc "ConnectionSettings for setting up a BigQuery query connection."
   :file-git-sha "bed2e0ea0969d9bb1bb3be75c9b7afc6cc1e8f1a"
   :fqcn "com.google.cloud.bigquery.ConnectionSettings"
   :gcp.dev/certification
     {:base-seed 1790034069175
      :manifest "068dae53-75f2-5aa6-8d27-30391b1c6297"
      :passed-stages
        {:smoke 1790034069175 :standard 1790034069176 :stress 1790034069177}
      :protocol-hash
        "75d3372fb35f1e40bc5550be4e402bfd0b7a7edb8010ca96440bb4161b829c72"
      :timestamp "2026-09-21T23:41:11.354231811Z"}}
...
(defn ^ConnectionSettings from-edn
  [arg]
  (global/strict! :gcp.bigquery/ConnectionSettings arg)
  (let [builder (ConnectionSettings/newBuilder)]
    ...
    (when (some? (get arg :maxResults))
      (.setMaxResults builder (long (get arg :maxResults))))
    ...
    (when (some? (get arg :maximumBytesBilled))
      (.setMaximumBytesBilled builder (long (get arg :maximumBytesBilled))))
    ...
    (when (some? (get arg :priority))
      (.setPriority builder
                    (QueryJobConfiguration/Priority-from-edn (get arg
                                                                  :priority))))
...
(defn to-edn
  ...
  {:post [(global/strict! :gcp.bigquery/ConnectionSettings %)]}
  (when arg
    (cond-> {}
      ...
      (.getNumBufferedRows arg) (assoc :numBufferedRows
                                  (.getNumBufferedRows arg))
      (.getPriority arg) (assoc :priority
                           (QueryJobConfiguration/Priority-to-edn (.getPriority
                                                                    arg)))
...
(def schema
  [:map
   {:closed true,
    ...
    :gcp/key :gcp.bigquery/ConnectionSettings}
   [:allowLargeResults
    {:optional true,
     :getter-doc
   ...
   [:priority
    ...
    :gcp.bigquery/QueryJobConfiguration.Priority]
   [:rangePartitioning
    {:optional true,
...
(global/include-registry! "gcp.bigquery.ConnectionSettings"
                          {:gcp.bigquery/ConnectionSettings schema})