...
(ns gcp.bindings.services.bigquery.model.ArimaModelInfo
  {:doc
     "Arima model information.\n\n<p> This is the Java data model class that specifies how to parse/serialize into the JSON that is\ntransmitted over HTTP when working with the BigQuery API. For a detailed explanation see:\n<a href=\"https://developers.google.com/api-client-library/java/google-http-java-client/json\">https://developers.google.com/api-client-library/java/google-http-java-client/json</a>\n</p>\n\n@author Google, Inc."
   :file-git-sha "71853cb52ee53d1c4f9de7baa4b49fe406c6735c"
   :fqcn "com.google.api.services.bigquery.model.ArimaModelInfo"
   :gcp.dev/certification
     {:base-seed 1772390233073
      :manifest "2096f8e8-3cdd-50e2-9b64-67d099f5c3be"
      :passed-stages
        {:smoke 1772390233073 :standard 1772390233074 :stress 1772390233075}
      :protocol-hash
        "f22c161c7a00aa071f6a8b78764e5c684eaa491c76675456f17e0b44b2b8578c"
      :timestamp "2026-03-01T18:37:13.224487479Z"}}
  (:require [gcp.bindings.services.bigquery.model.ArimaCoefficients :as
             ArimaCoefficients]
  ...
  (:import [com.google.api.services.bigquery.model ArimaModelInfo]))

(defn ^ArimaModelInfo from-edn
  [arg]
  (global/strict! :gcp.bindings.services.bigquery.model/ArimaModelInfo arg)
  (let [o (new ArimaModelInfo)]
    (when (some? (get arg :arimaCoefficients))
      (.setArimaCoefficients o
                             (ArimaCoefficients/from-edn
                               (get arg :arimaCoefficients))))
...
(defn to-edn
  [^ArimaModelInfo arg]
  {:post [(global/strict! :gcp.bindings.services.bigquery.model/ArimaModelInfo
                          %)]}
  (cond-> {}
    (.getArimaCoefficients arg) (assoc :arimaCoefficients
                                  (ArimaCoefficients/to-edn
                                    (.getArimaCoefficients arg)))
    ...
    (.getTimeSeriesId arg) (assoc :timeSeriesId (.getTimeSeriesId arg))
    (.getTimeSeriesIds arg) (assoc :timeSeriesIds
...
(def schema
  [:map
   {:closed true,
    ...
    :gcp/key :gcp.bindings.services.bigquery.model/ArimaModelInfo}
   [:arimaCoefficients
    {:getter-doc
       "Arima coefficients.\n\n@return value or {@code null} for none",
     :setter-doc
       "Arima coefficients.\n\n@param arimaCoefficients arimaCoefficients or {@code null} for none",
     :optional true} :gcp.bindings.services.bigquery.model/ArimaCoefficients]
   [:arimaFittingMetrics
    {:getter-doc
       "Arima fitting metrics.\n\n@return value or {@code null} for none",
     :setter-doc
       "Arima fitting metrics.\n\n@param arimaFittingMetrics arimaFittingMetrics or {@code null} for none",
     :optional true} :gcp.bindings.services.bigquery.model/ArimaFittingMetrics]
   [:hasDrift
    {:getter-doc
...
(global/include-schema-registry!
  (with-meta {:gcp.bindings.services.bigquery.model/ArimaModelInfo schema}
    {:gcp.global/name "gcp.bindings.services.bigquery.model.ArimaModelInfo"}))