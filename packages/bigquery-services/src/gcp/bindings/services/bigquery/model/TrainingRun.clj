...
(ns gcp.bindings.services.bigquery.model.TrainingRun
  {:doc
   ...
   :gcp.dev/certification
     {:base-seed 1772390267785
      :manifest "2096f8e8-3cdd-50e2-9b64-67d099f5c3be"
      :passed-stages
        {:smoke 1772390267785 :standard 1772390267786 :stress 1772390267787}
      :protocol-hash
        "f22c161c7a00aa071f6a8b78764e5c684eaa491c76675456f17e0b44b2b8578c"
      :timestamp "2026-03-01T18:37:52.204711555Z"}}
  (:require
    [gcp.bindings.services.bigquery.model.DataSplitResult :as DataSplitResult]
    [gcp.bindings.services.bigquery.model.EvaluationMetrics :as
     EvaluationMetrics]
    [gcp.bindings.services.bigquery.model.GlobalExplanation :as
     GlobalExplanation]
    [gcp.bindings.services.bigquery.model.IterationResult :as IterationResult]
    [gcp.bindings.services.bigquery.model.TrainingOptions :as TrainingOptions]
    [gcp.global :as global])
  (:import [com.google.api.services.bigquery.model TrainingRun]))

(defn ^TrainingRun from-edn
  [arg]
  (global/strict! :gcp.bindings.services.bigquery.model/TrainingRun arg)
  (let [o (new TrainingRun)]
    ...
    (when (some? (get arg :trainingStartTime))
      (.setTrainingStartTime o (get arg :trainingStartTime)))
...
(defn to-edn
  [^TrainingRun arg]
  {:post [(global/strict! :gcp.bindings.services.bigquery.model/TrainingRun %)]}
  (cond-> {}
    ...
    (.getResults arg) (assoc :results
                        (map IterationResult/to-edn (.getResults arg)))
    (.getStartTime arg) (assoc :startTime (.getStartTime arg))
    ...
    (.getVertexAiModelId arg) (assoc :vertexAiModelId (.getVertexAiModelId arg))
    (.getVertexAiModelVersion arg) (assoc :vertexAiModelVersion
                                     (.getVertexAiModelVersion arg))))
...
(def schema
  [:map
   {:closed true,
    ...
    :gcp/key :gcp.bindings.services.bigquery.model/TrainingRun}
   [:classLevelGlobalExplanations
    {:getter-doc
   ...
   [:dataSplitResult
    {:getter-doc
     ...
     :optional true} :gcp.bindings.services.bigquery.model/DataSplitResult]
   [:evaluationMetrics
    {:getter-doc
     ...
     :optional true} :gcp.bindings.services.bigquery.model/EvaluationMetrics]
   [:modelLevelGlobalExplanation
    {:getter-doc
     ...
     :optional true} :gcp.bindings.services.bigquery.model/GlobalExplanation]
   [:results
    {:getter-doc
     ...
     :optional true}
    [:sequential {:min 1}
     :gcp.bindings.services.bigquery.model/IterationResult]]
   [:startTime
    {:getter-doc
   ...
   [:trainingOptions
    {:getter-doc
     ...
     :optional true} :gcp.bindings.services.bigquery.model/TrainingOptions]
   [:trainingStartTime
    {:getter-doc
...
(global/include-schema-registry!
  (with-meta {:gcp.bindings.services.bigquery.model/TrainingRun schema}
    {:gcp.global/name "gcp.bindings.services.bigquery.model.TrainingRun"}))