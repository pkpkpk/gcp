...
(defn ^CountTokensRequest from-edn
  [{:keys [model
           ...
           tools]
    :as arg}]
  (global/strict! :gcp.vertexai.v1.api/CountTokensRequest arg)
...
(defn to-edn [^CountTokensRequest arg]
  {:post [(global/strict! :gcp.vertexai.v1.api/CountTokensRequest %)]}
