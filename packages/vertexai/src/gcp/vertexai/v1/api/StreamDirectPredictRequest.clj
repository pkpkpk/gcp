(ns gcp.vertexai.v1.api.StreamDirectPredictRequest
  (:require [gcp.global :as global]
            [gcp.vertexai.v1.api.Tensor :as Tensor])
  (:import (com.google.cloud.vertexai.api StreamDirectPredictRequest)))

(defn ^StreamDirectPredictRequest from-edn
  [{:keys [endpoint inputs parameters] :as arg}]
  (global/strict! :gcp.vertexai.v1.api/StreamDirectPredictRequest arg)
  (let [builder (StreamDirectPredictRequest/newBuilder)]
...
(defn to-edn [^StreamDirectPredictRequest arg]
  {:post [(global/strict! :gcp.vertexai.v1.api/StreamDirectPredictRequest %)]}
  (cond-> {}
...
(def schema
  [:map
   {:doc              "Request message for [DirectPredictionService.StreamDirectPredict]"
    :class            'com.google.cloud.vertexai.api.StreamDirectPredictRequest
    :protobuf/type    "google.cloud.vertexai.v1.StreamDirectPredictRequest"}
...
(global/register-schema! :gcp.vertexai.v1.api/StreamDirectPredictRequest schema)
