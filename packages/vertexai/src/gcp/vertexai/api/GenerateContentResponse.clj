...
(ns gcp.vertexai.api.GenerateContentResponse
  {:doc
   ...
   :gcp.dev/certification
     {:base-seed 1774824799857
      :manifest "2e809e6a-933c-51dd-8bb9-567961e7a29e"
      :passed-stages
        {:smoke 1774824799857 :standard 1774824799858 :stress 1774824799859}
      :protocol-hash
        "b44d2581e3979d0a946f2f9d3973f275b05bb339485f3d5eb436c47b54f7dc70"
      :timestamp "2026-03-29T22:53:23.878638633Z"}}
...
(defn to-edn
  ...
  (cond-> {}
    ...
    (.hasPromptFeedback arg) (assoc :promptFeedback
                               (PromptFeedback-to-edn (.getPromptFeedback arg)))
    (some->> (.getResponseId arg)
             (not= ""))
      (assoc :responseId (.getResponseId arg))
    (.hasUsageMetadata arg) (assoc :usageMetadata
                              (UsageMetadata-to-edn (.getUsageMetadata arg)))))
