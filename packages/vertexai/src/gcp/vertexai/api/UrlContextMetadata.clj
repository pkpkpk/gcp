...
(ns gcp.vertexai.api.UrlContextMetadata
  {:doc
   ...
   :gcp.dev/certification
     {:base-seed 1774824749109
      :manifest "2e809e6a-933c-51dd-8bb9-567961e7a29e"
      :passed-stages
        {:smoke 1774824749109 :standard 1774824749110 :stress 1774824749111}
      :protocol-hash
        "b44d2581e3979d0a946f2f9d3973f275b05bb339485f3d5eb436c47b54f7dc70"
      :timestamp "2026-03-29T22:52:30.081567077Z"}}
...
(defn to-edn
  ...
  (cond-> {}
    (seq (.getUrlMetadataList arg))
      (assoc :urlMetadata (map UrlMetadata/to-edn (.getUrlMetadataList arg)))))
