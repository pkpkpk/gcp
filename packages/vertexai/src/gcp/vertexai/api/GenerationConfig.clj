...
(ns gcp.vertexai.api.GenerationConfig
  {:doc
   ...
   :gcp.dev/certification
     {:base-seed 1774824615111
      :manifest "2e809e6a-933c-51dd-8bb9-567961e7a29e"
      :passed-stages
        {:smoke 1774824615111 :standard 1774824615112 :stress 1774824615113}
      :protocol-hash
        "b44d2581e3979d0a946f2f9d3973f275b05bb339485f3d5eb436c47b54f7dc70"
      :timestamp "2026-03-29T22:50:18.619547101Z"}}
...
(defn
  ...
  (cond-> {}
    (.hasModelRoutingPreference arg)
      (assoc :modelRoutingPreference (.name (.getModelRoutingPreference arg)))))
...
(defn ^GenerationConfig$RoutingConfig RoutingConfig-from-edn
  ...
  (let [builder (GenerationConfig$RoutingConfig/newBuilder)]
    (clojure.core/cond (contains? arg :autoMode)
                         (.setAutoMode builder
                                       (RoutingConfig$AutoRoutingMode-from-edn
                                         (get arg :autoMode)))
...
(defn RoutingConfig-to-edn
  ...
  (clojure.core/let [res (cond-> {})
                     res (case (.name (.getRoutingConfigCase arg))
                           "AUTO_MODE" (clojure.core/assoc res
                                         :autoMode
                                           (RoutingConfig$AutoRoutingMode-to-edn
                                             (.getAutoMode arg)))
                           "MANUAL_MODE"
...
(defn ThinkingConfig-to-edn
  ...
  (cond-> {}
    (.hasIncludeThoughts arg) (assoc :includeThoughts (.getIncludeThoughts arg))
    (.hasThinkingBudget arg) (assoc :thinkingBudget (.getThinkingBudget arg))))
...
(defn to-edn
  ...
  (cond-> {}
    ...
    (.hasMaxOutputTokens arg) (assoc :maxOutputTokens (.getMaxOutputTokens arg))
    (.hasPresencePenalty arg) (assoc :presencePenalty (.getPresencePenalty arg))
    ...
    (.hasThinkingConfig arg) (assoc :thinkingConfig
                               (ThinkingConfig-to-edn (.getThinkingConfig arg)))
  ...
  [:map
   ...
   [:routingConfig
    {:optional true,
     ...
     :setter-doc
       "<pre>\nOptional. Routing configuration.\n</pre>\n\n<code>\noptional .google.cloud.vertexai.v1.GenerationConfig.RoutingConfig routing_config = 17 [(.google.api.field_behavior) = OPTIONAL];\n</code>"}
    :gcp.vertexai.api/GenerationConfig.RoutingConfig]
   [:seed
    {:optional true,
     :getter-doc
   ...
   [:thinkingConfig
    {:optional true,
     ...
     :setter-doc
       "<pre>\nOptional. Config for thinking features.\nAn error will be returned if this field is set for models that don't\nsupport thinking.\n</pre>\n\n<code>\n.google.cloud.vertexai.v1.GenerationConfig.ThinkingConfig thinking_config = 25 [(.google.api.field_behavior) = OPTIONAL];\n</code>"}
    :gcp.vertexai.api/GenerationConfig.ThinkingConfig]
   [:topK
    {:optional true,
     :getter-doc
