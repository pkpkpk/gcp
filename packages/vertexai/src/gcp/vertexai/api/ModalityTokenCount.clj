...
(ns gcp.vertexai.api.ModalityTokenCount
  {:doc
   ...
   :gcp.dev/certification
     {:base-seed 1774824757235
      :manifest "2e809e6a-933c-51dd-8bb9-567961e7a29e"
      :passed-stages
        {:smoke 1774824757235 :standard 1774824757236 :stress 1774824757237}
      :protocol-hash
        "b44d2581e3979d0a946f2f9d3973f275b05bb339485f3d5eb436c47b54f7dc70"
      :timestamp "2026-03-29T22:52:38.172365510Z"}}
...
(defn to-edn
  ...
  (cond-> {} (.getModality arg) (assoc :modality (.name (.getModality arg)))))
