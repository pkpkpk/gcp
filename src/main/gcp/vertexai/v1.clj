...
(def registry
    ...
    ::g/name ::registry}
  {
   ...
   :vertexai.synth/clientable            [:maybe [:or (g/instance-schema com.google.cloud.vertexai.VertexAI) :vertexai/VertexAI]]
   ...
   :vertexai.synth/ResponderState        [:and (g/instance-schema clojure.lang.Atom)
   ...
   :vertexai.synth/ChatSession           [:and
                                          ...
                                          [:map
                                           ...
                                           ;;TODO satisfies schemas are not edn-safe because of sci cannot do requiring-resolve
                                           ;[:history {:optional false} (global/satisfies-schema gcp.vertexai.v1.generativeai.protocols/IHistory)]
                                           ...
                                           [:*responderState {:optional false} :vertexai.synth/ResponderState]
