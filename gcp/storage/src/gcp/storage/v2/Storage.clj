(ns gcp.storage.v2.Storage
  (:import (com.google.cloud.storage Storage$BlobGetOption Storage$BlobListOption Storage$BlobSourceOption Storage$BlobTargetOption Storage$BucketGetOption Storage$BucketListOption Storage$BucketTargetOption)))
